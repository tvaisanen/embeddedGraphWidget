    ...
    function (contextMenuItems,
        ...
        function createEdgesToNodes(props) {
            ...
            props.nodesToCreateEdges.forEach(function (targetNodeId) {
                console.debug('createEdgesToNodes');
                console.debug(props.nodesToCreateEdges);
                try {
         ...
         * @function
         * @name createNewEdge
         * @description Create new edge to the cytoscape graph instance.
         * @param {Object} props
        ...
        function createNewEdge(props) {
            ...
            try {
                ...
                if (edgeExists({edgeId: edgeId, cy: props.cy})) {
                    ...
                    console.debug('add new edge');
                    console.debug(newEdge);
                    cy.add(newEdge);
        ...
        function createNewNode(props) {
            ...
            try {
                ...
                var nodeIdOk = nodeIdAvailable({nodeId: props.id, cy: cy});
                if (nodeIdOk) {
                    console.debug('node id ok');
                    console.debug('create new node');
        ...
        function createNodesAndEdgeBetween(props) {
            console.debug('createNodesAndEdgeBetween');
            try {
        ...
        function initCytoscape(props) {
            console.group('graphUtils.initCytoscape(props)');
            console.debug(props);
            // props.contextMenuItems = contextMenuItems();
            // contextMenuItems.hello();
            cy = cyInitUtils.init(props);

            // expand the root page
            expandNode({nodeId: props.pagename, cy: cy});
