    ...
    function (classNames, pageTemplates) {
        ...
        function TemplateFormManager(componentId, labelText) {
            ...
            this.getForms = function(){
                ...
                // empty array for storing the value objects
                var formValues = [];

                // loop through the forms stored in listItems
                self.listItems.forEach(function(form){

                    // new template data object to be added to formValues
                    var templateData = {name: form.name};

                    // loop through form elements and store the
                    // key-value pairs to the template data object
                ...
                //for development
                console.debug(JSON.stringify(formValues));
